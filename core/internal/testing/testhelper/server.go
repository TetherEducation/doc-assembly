...
import (
	...
	contentvalidator "github.com/TetherEducation/doc-assembly/core/internal/core/service/template/contentvalidator"
...
func NewTestServerWithResolver(t *testing.T, pool *pgxpool.Pool, templateResolver port.TemplateResolver) *TestServer {
	...
	automationCtrl.RegisterRoutes(engine, middlewareProvider, config.AutomationConfig{}.MaxBodyBytesOrDefault())
